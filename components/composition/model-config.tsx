      ...
      <CardContent className="px-6 pb-6 h-full">
        <div className="flex items-center w-full justify-center gap-4 pb-6 mb-6">
          ...
          <div className="text-center w-full border">
            ...
            <p className="text-xs md:text-base text-gray-500 mt-1">Model B</p>
          </div>
        </div>
        ...
        <div className="flex w-full h-full gap-4 flex-col md:flex-row">
          ...
          <div className="flex w-full flex-col h-full space-y-6">
            <div className="flex w-full flex-col gap-2">
              <div className="flex justify-between">
                <p className="font-bold text-sm md:text-base">Temperature</p>
            ...
            <div className="flex w-full flex-row gap-2 justify-between">
              ...
              <Badge
                variant={`${config?.json_format ? "default" : "destructive"}`}
          ...
          <div className="flex w-full flex-col  h-full flex-grow">
            <div className="flex flex-col h-full flex-grow gap-2">
              <p className="font-bold text-sm md:text-base">System Prompt</p>
